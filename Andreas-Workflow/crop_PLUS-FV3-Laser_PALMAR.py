...
for imagePath in a.indexOfAssets['PLUS-FV3-Laser_PALMAR']: # Slicing with [13:]
  ...
  part_img = crop_img[math.floor(partHeight * 0.35): math.floor(partHeight * 0.85), math.floor(partWidth * 0.30): math.floor(partWidth * 0.80)]
