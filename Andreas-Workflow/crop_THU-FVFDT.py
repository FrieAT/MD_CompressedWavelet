...
for imagePath in a.indexOfAssets['THU-FVFDT']: # Slicing with [13:]
  ...
  part_img = crop_img[math.floor(partHeight * 0.10): math.floor(partHeight * 0.65), math.floor(partWidth * 0.30): math.floor(partWidth * 0.70)]
