...
#Cropping (INDEX: 50) image ../images\SCUT_FVD\real\29\29_3_1_0_6.bmp...
#Cropping (INDEX: 49) image ../images\SCUT_FVD\real\29\29_2_1_0_6.bmp...
#Cropping (INDEX: 48) image ../images\SCUT_FVD\real\29\29_1_1_0_6.bmp...
#threshed bischen heller machen!
...
for imagePath in a.indexOfAssets['SCUT_FVD']: # Slicing with [13:]
  ...
  crop_img = img[framemax[1]: framemax[1] + framemax[3], framemax[0]: framemax[0] + framemax[2]]
  
  partHeight, partWidth = crop_img.shape
  part_img = crop_img[math.floor(partHeight * 0.15): math.floor(partHeight * 0.80), math.floor(partWidth * 0.20): math.floor(partWidth * 0.70)]
