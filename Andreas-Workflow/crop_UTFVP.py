...
for imagePath in a.indexOfAssets['UTFVP']: # Slicing with [13:]
  ...
  part_img = crop_img[math.floor(partHeight * 0.30): math.floor(partHeight * 0.65), 0: math.floor(partWidth * 0.80)]
