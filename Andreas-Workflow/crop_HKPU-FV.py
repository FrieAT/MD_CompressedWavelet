...
for imagePath in a.indexOfAssets['HKPU-FV']: # Slicing with [13:]
  ...
  part_img = crop_img[math.floor(partHeight * 0.23): math.floor(partHeight * 0.82), math.floor(partWidth * 0.15): math.floor(partWidth * 0.70)]
  part_img = ~part_img
