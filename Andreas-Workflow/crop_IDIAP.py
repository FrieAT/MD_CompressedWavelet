...
for imagePath in a.indexOfAssets['IDIAP']: # Slicing with [13:]
  ...
  part_img = crop_img[math.floor(partHeight * 0.30): math.floor(partHeight * 0.70), 0: math.floor(partWidth * 0.80)]
