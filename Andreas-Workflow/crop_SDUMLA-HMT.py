...
for imagePath in a.indexOfAssets['SDUMLA-HMT']: # Slicing with [13:]
  ...
  part_img = crop_img[math.floor(partHeight * 0.30): math.floor(partHeight * 0.75), math.floor(partWidth * 0.05): math.floor(partWidth * 0.90)]
